...
class DefaultCommand extends PluginCommand
{
    ...
    public function __construct(BedWars $owner)
    {
        ...
        parent::setDescription("BedWars Main command");
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args)
    {
        ...
        switch(strtolower($args[0])){
            ...
            if(!$sender instanceof Player) {
             ...
             $arena = array_values($this->getPlugin()->games);
            $best = $arena[0];
            foreach($arena as $game){
    ...
    private function sendUsage(CommandSender $sender) : void{
        ...
        $sender->sendMessage(TextFormat::GREEN . "/bedwars addteam " . TextFormat::YELLOW . "Adds a team to the arena");
    }
