...
class Generator
{
    ...
    public function tick() : void{
        if($this->spawnText){
            $text = TextFormat::YELLOW . "§lTIER " . TextFormat::RED . Utils::rome($this->tier) . "§r\n".
                self::TITLE[$this->itemID] . "\n".
                TextFormat::YELLOW . "§rSpawns in " . TextFormat::RED . $this->dynamicSpawnTime;
    ...
    public function updateTier() : void{
        ...
        //-20%
        $this->repeatRate = $this->repeatRate - ($this->repeatRate * 600 / 20);
    }
